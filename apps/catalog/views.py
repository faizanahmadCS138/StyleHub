...
def product_list_view(request):
    ...
    products = Product.objects.filter(is_active=True).prefetch_related('images', 'variants', 'tags')
...
def product_detail_view(request, slug):
    ...
    """
    print("Normal view request.user:", request.user)
    print("Normal view session:", request.session.session_key)
